...
public class SignTools {
	private static Logger logger = LoggerFactory.getLogger(SignTools.class);
	/**
	 * 签名生成算法
	...
	public static String getSignature(HashMap<String,String> params,String privateKey) 
	{
	    ...
	    logger.info("验签:::::::::::::::"+sign.toString().toUpperCase());
	...
	public static boolean cheakSignature(Map<String,String> params,String secret,String thesign) throws IOException
	{
		...
		return thesign.equals(sign.toString().toUpperCase());
	}

	public static String getSignature(Map params,String privateKey)
	{
		// 先将参数以其参数名的字典序升序进行排序
		Map sortedParams = new TreeMap(params);
		Set<Entry> entrys = sortedParams.entrySet();
		// 遍历排序后的字典，将所有参数按"key=value"格式拼接在一起
		StringBuilder basestring = new StringBuilder();
		...
		basestring.append(privateKey);
		return Md5Utils.md5(basestring.toString()).toUpperCase();
	}
}
